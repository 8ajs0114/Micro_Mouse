...
DW$1	.dwtag  DW_TAG_subprogram, DW_AT_name("SENSOR_ISR"), DW_AT_symbol_name("_SENSOR_ISR")
	.dwattr DW$1, DW_AT_declaration(0x01)
	.dwattr DW$1, DW_AT_external(0x01)

DW$2	.dwtag  DW_TAG_subprogram, DW_AT_name("ADC_ISR"), DW_AT_symbol_name("_ADC_ISR")
	.dwattr DW$2, DW_AT_declaration(0x01)
	.dwattr DW$2, DW_AT_external(0x01)

DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("MOTOR_ISR"), DW_AT_symbol_name("_MOTOR_ISR")
...
;*** 141	-----------------------    return;
 ...
 EDIS
	...
	.dwpsn	"DSP280x_CpuTimers.c",138,2
        ...
        MOV       AH,#17402
        MOVL      *-SP[2],ACC           ; |138| 
        MOVL      XAR4,#_CpuTimer2      ; |138| 
        MOV       AH,#17096
        LCR       #_ConfigCpuTimer      ; |138| 
        ; call occurs [#_ConfigCpuTimer] ; |138| 
 ...
 clrc DBGM
	...
	.dwattr DW$19, DW_AT_end_line(0x8f)
