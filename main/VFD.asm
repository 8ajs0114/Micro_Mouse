...
;***************************************************************
_VfdCtlRegInit:
;*** 170	-----------------------    C$2 = &GpioDataRegs;
;*** 170	-----------------------    ((volatile unsigned *)C$2)[5] |= 0x400u;
;*** 171	-----------------------    ((volatile unsigned *)C$2)[3] |= 0x80u;
;*** 172	-----------------------    *((volatile struct _GPBDAT_BITS *)C$2+10L) |= 1u;
;*** 173	-----------------------    *(&GpioDataRegs+3L) |= 0x400u;
;*** 174	-----------------------    *((volatile struct _GPBDAT_BITS *)C$2+12L) |= 1u;
...
;***	-----------------------g2:
;*** 179	-----------------------    *(&GpioDataRegs+5L) |= 0x400u;
;*** 180	-----------------------    if ( CrlReg&1<<Cnt ) goto g4;
	.dwpsn	"VFD.c",179,3
        OR        @_GpioDataRegs+5,#0x0400 ; |179| 
	.dwpsn	"VFD.c",180,3
        MOVB      AL,#1                 ; |180| 
        MOV       T,AH                  ; |180| 
        LSL       AL,T                  ; |180| 
...
;*** 186	-----------------------    *(&GpioDataRegs+5L) |= 0x40u;
;*** 186	-----------------------    goto g5;
	.dwpsn	"VFD.c",186,4
        OR        @_GpioDataRegs+5,#0x0040 ; |186| 
        BF        L3,UNC                ; |186| 
        ; branch occurs ; |186| 
...
;***	-----------------------g4:
;*** 182	-----------------------    *(&GpioDataRegs+3L) |= 0x40u;
	.dwpsn	"VFD.c",182,4
        OR        @_GpioDataRegs+3,#0x0040 ; |182| 
DW$L$_VfdCtlRegInit$4$E:
L3:    
DW$L$_VfdCtlRegInit$5$B:
;***	-----------------------g5:
;*** 188	-----------------------    *(&GpioDataRegs+3L) |= 0x400u;
;*** 177	-----------------------    --Cnt;
;*** 177	-----------------------    if ( (--L$1) != (-1) ) goto g2;
	.dwpsn	"VFD.c",188,3
        OR        @_GpioDataRegs+3,#0x0400 ; |188| 
	.dwpsn	"VFD.c",177,24
        ADDB      AH,#-1
	.dwpsn	"VFD.c",177,14
        BANZ      L1,AR6--              ; |177| 
...
;*** 191	-----------------------    ((volatile unsigned *)C$1)[10] |= 1u;
;*** 192	-----------------------    *((volatile struct _GPADAT_BITS *)C$1+5L) |= 0x400u;
;*** 192	-----------------------    return;
	.dwpsn	"VFD.c",191,2
        MOVB      ACC,#10
        ADDL      ACC,XAR5
	...
	.dwpsn	"VFD.c",192,2
        OR        *+XAR5[5],#0x0400     ; |192| 
	.dwpsn	"VFD.c",194,1
        LRETR
        ; return occurs

DW$14	.dwtag  DW_TAG_loop
	.dwattr DW$14, DW_AT_name("H:\Tracer_Mouse\Mouse\SPIDER_MINE\main\VFD.asm:L1:1:1675863922")
...
DW$15	.dwtag  DW_TAG_loop_range
	.dwattr DW$15, DW_AT_low_pc(DW$L$_VfdCtlRegInit$2$B)
	.dwattr DW$15, DW_AT_high_pc(DW$L$_VfdCtlRegInit$2$E)
DW$16	.dwtag  DW_TAG_loop_range
	.dwattr DW$16, DW_AT_low_pc(DW$L$_VfdCtlRegInit$3$B)
	.dwattr DW$16, DW_AT_high_pc(DW$L$_VfdCtlRegInit$3$E)
DW$17	.dwtag  DW_TAG_loop_range
	.dwattr DW$17, DW_AT_low_pc(DW$L$_VfdCtlRegInit$4$B)
	.dwattr DW$17, DW_AT_high_pc(DW$L$_VfdCtlRegInit$4$E)
DW$18	.dwtag  DW_TAG_loop_range
	.dwattr DW$18, DW_AT_low_pc(DW$L$_VfdCtlRegInit$5$B)
	.dwattr DW$18, DW_AT_high_pc(DW$L$_VfdCtlRegInit$5$E)
	.dwendtag DW$14
...
DW$19	.dwtag  DW_TAG_subprogram, DW_AT_name("VfdInit"), DW_AT_symbol_name("_VfdInit")
	.dwattr DW$19, DW_AT_low_pc(_VfdInit)
	.dwattr DW$19, DW_AT_high_pc(0x00)
	.dwattr DW$19, DW_AT_begin_file("VFD.c")
	.dwattr DW$19, DW_AT_begin_line(0xc3)
...
;*** 197	-----------------------    ((volatile unsigned *)C$1)[12] |= 1u;
;*** 198	-----------------------    *((volatile struct _GPADAT_BITS *)C$1+5L) |= 0x400u;
;*** 199	-----------------------    *(&GpioDataRegs+5L) |= 0x40u;
;*** 200	-----------------------    *(&GpioDataRegs+5L) |= 0x80u;
...
DW$20	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	.dwattr DW$20, DW_AT_type(*DW$T$56)
	...
	.dwpsn	"VFD.c",197,2
        ...
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |197| 
        OR        *+XAR4[0],#0x0001     ; |197| 
	.dwpsn	"VFD.c",198,2
        OR        *+XAR5[5],#0x0400     ; |198| 
	.dwpsn	"VFD.c",199,2
        MOVW      DP,#_GpioDataRegs+5
        OR        @_GpioDataRegs+5,#0x0040 ; |199| 
	.dwpsn	"VFD.c",200,2
        OR        @_GpioDataRegs+5,#0x0080 ; |200| 
	.dwpsn	"VFD.c",201,2
        MOVB      AL,#129               ; |201| 
	...
	.dwpsn	"VFD.c",203,1
        LRETR
        ; return occurs
	.dwattr DW$19, DW_AT_end_file("VFD.c")
	.dwattr DW$19, DW_AT_end_line(0xcb)
...
DW$21	.dwtag  DW_TAG_subprogram, DW_AT_name("VfdDataLoad"), DW_AT_symbol_name("_VfdDataLoad")
	.dwattr DW$21, DW_AT_low_pc(_VfdDataLoad)
	.dwattr DW$21, DW_AT_high_pc(0x00)
	.dwattr DW$21, DW_AT_begin_file("VFD.c")
	.dwattr DW$21, DW_AT_begin_line(0xcd)
...
;*** 215	-----------------------    ((volatile unsigned *)K$2)[5] |= 0x400u;
;*** 216	-----------------------    ((volatile unsigned *)K$2)[5] |= 0x80u;
;*** 217	-----------------------    *((volatile struct _GPBDAT_BITS *)K$2+10L) |= 1u;
;*** 218	-----------------------    ((volatile unsigned *)K$2)[3] |= 0x400u;
;*** 219	-----------------------    *((volatile struct _GPBDAT_BITS *)K$2+12L) |= 1u;
;***  	-----------------------    #pragma MUST_ITERATE(8, 8, 8)
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;***  	-----------------------    K$26 = (char *)(&FontData);
;*** 211	-----------------------    ConverData = 0;
...
DW$22	.dwtag  DW_TAG_formal_parameter, DW_AT_name("Buff"), DW_AT_symbol_name("_Buff")
	.dwattr DW$22, DW_AT_type(*DW$T$31)
	.dwattr DW$22, DW_AT_location[DW_OP_reg12]
;* PH    assigned to U$28
DW$23	.dwtag  DW_TAG_variable, DW_AT_name("U$28"), DW_AT_symbol_name("U$28")
	.dwattr DW$23, DW_AT_type(*DW$T$5)
	.dwattr DW$23, DW_AT_location[DW_OP_reg3]
;* AR7   assigned to K$26
DW$24	.dwtag  DW_TAG_variable, DW_AT_name("K$26"), DW_AT_symbol_name("K$26")
	.dwattr DW$24, DW_AT_type(*DW$T$35)
	.dwattr DW$24, DW_AT_location[DW_OP_reg18]
;* AR4   assigned to L$1
DW$25	.dwtag  DW_TAG_variable, DW_AT_name("L$1"), DW_AT_symbol_name("L$1")
	.dwattr DW$25, DW_AT_type(*DW$T$10)
	.dwattr DW$25, DW_AT_location[DW_OP_reg12]
;* AR6   assigned to L$3
DW$26	.dwtag  DW_TAG_variable, DW_AT_name("L$3"), DW_AT_symbol_name("L$3")
	.dwattr DW$26, DW_AT_type(*DW$T$10)
	.dwattr DW$26, DW_AT_location[DW_OP_reg16]
;* AR6   assigned to L$4
DW$27	.dwtag  DW_TAG_variable, DW_AT_name("L$4"), DW_AT_symbol_name("L$4")
	.dwattr DW$27, DW_AT_type(*DW$T$10)
	.dwattr DW$27, DW_AT_location[DW_OP_reg16]
;* PL    assigned to _ConverData
DW$28	.dwtag  DW_TAG_variable, DW_AT_name("ConverData"), DW_AT_symbol_name("_ConverData")
	.dwattr DW$28, DW_AT_type(*DW$T$10)
	.dwattr DW$28, DW_AT_location[DW_OP_reg2]
;* AL    assigned to _y
DW$29	.dwtag  DW_TAG_variable, DW_AT_name("y"), DW_AT_symbol_name("_y")
...
;* AL    assigned to _x
DW$31	.dwtag  DW_TAG_variable, DW_AT_name("x"), DW_AT_symbol_name("_x")
	.dwattr DW$31, DW_AT_type(*DW$T$10)
	.dwattr DW$31, DW_AT_location[DW_OP_reg0]
;* AR5   assigned to _Buff
DW$32	.dwtag  DW_TAG_variable, DW_AT_name("Buff"), DW_AT_symbol_name("_Buff")
	.dwattr DW$32, DW_AT_type(*DW$T$31)
	.dwattr DW$32, DW_AT_location[DW_OP_reg14]
;* AR7   assigned to K$2
DW$33	.dwtag  DW_TAG_variable, DW_AT_name("K$2"), DW_AT_symbol_name("K$2")
...
DW$35	.dwtag  DW_TAG_variable, DW_AT_name("K$2"), DW_AT_symbol_name("K$2")
	...
	.dwattr DW$35, DW_AT_location[DW_OP_reg4]
        MOVL      XAR5,XAR4             ; |206| 
	.dwpsn	"VFD.c",215,2
        MOVL      XAR7,#_GpioDataRegs   ; |215| 
        OR        *+XAR7[5],#0x0400     ; |215| 
	.dwpsn	"VFD.c",216,2
        OR        *+XAR7[5],#0x0080     ; |216| 
	.dwpsn	"VFD.c",217,2
        MOVB      ACC,#10
        ADDL      ACC,XAR7
        MOVL      XAR6,ACC              ; |217| 
        OR        *+XAR6[0],#0x0001     ; |217| 
	.dwpsn	"VFD.c",218,2
        OR        *+XAR7[3],#0x0400     ; |218| 
	.dwpsn	"VFD.c",219,2
        MOVB      ACC,#12
        ADDL      ACC,XAR7
        MOVL      XAR6,ACC              ; |219| 
        OR        *+XAR6[0],#0x0001     ; |219| 
        MOVL      XAR7,#_FontData
	.dwpsn	"VFD.c",211,6
        SETC      SXM
        MOV       PL,#0                 ; |211| 
...
;***	-----------------------g6:
;*** 231	-----------------------    K$2 = &GpioDataRegs+5L;
;*** 231	-----------------------    *(volatile unsigned *)K$2 |= 0x400u;
;*** 232	-----------------------    if ( ConverData&1<<x ) goto g8;
	.dwpsn	"VFD.c",231,5
        MOVL      XAR0,#_GpioDataRegs+5 ; |231| 
        OR        *+XAR0[0],#0x0400     ; |231| 
	.dwpsn	"VFD.c",232,5
        MOVB      AH,#1                 ; |232| 
        MOV       T,AL                  ; |232| 
        LSL       AH,T                  ; |232| 
...
;*** 238	-----------------------    *(volatile unsigned *)K$2 |= 0x40u;
;*** 238	-----------------------    goto g9;
	.dwpsn	"VFD.c",238,6
        OR        *+XAR0[0],#0x0040     ; |238| 
        BF        L9,UNC                ; |238| 
        ; branch occurs ; |238| 
...
;***	-----------------------g8:
;*** 234	-----------------------    *(&GpioDataRegs+3L) |= 0x40u;
	.dwpsn	"VFD.c",234,6
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0040 ; |234| 
DW$L$_VfdDataLoad$8$E:
L9:    
DW$L$_VfdDataLoad$9$B:
;***	-----------------------g9:
;*** 240	-----------------------    K$2 = &GpioDataRegs;
;*** 240	-----------------------    ((volatile unsigned *)K$2)[3] |= 0x400u;
;*** 229	-----------------------    --x;
;*** 229	-----------------------    if ( (--L$4) != (-1) ) goto g6;
	.dwpsn	"VFD.c",240,5
        MOVL      XAR0,#_GpioDataRegs   ; |240| 
        OR        *+XAR0[3],#0x0400     ; |240| 
	.dwpsn	"VFD.c",229,23
        ADDB      AL,#-1
	.dwpsn	"VFD.c",229,15
        BANZ      L7,AR6--              ; |229| 
...
;*** 246	-----------------------    *((volatile struct _GPBDAT_BITS *)K$2+10L) |= 1u;
;*** 247	-----------------------    ((volatile unsigned *)K$2)[5] |= 0x400u;
;*** 247	-----------------------    return;
	.dwpsn	"VFD.c",246,2
        MOVB      ACC,#10
        ADDL      ACC,XAR0
        MOVL      XAR4,ACC              ; |246| 
        OR        *+XAR4[0],#0x0001     ; |246| 
	.dwpsn	"VFD.c",247,2
        OR        *+XAR0[5],#0x0400     ; |247| 
	.dwpsn	"VFD.c",249,1
	.dwcfa	0x1d, -4
        MOVL      XAR1,*--SP
	.dwcfa	0x1d, -2
...
DW$36	.dwtag  DW_TAG_loop
	.dwattr DW$36, DW_AT_name("H:\Tracer_Mouse\Mouse\SPIDER_MINE\main\VFD.asm:L4:1:1675863922")
...
DW$37	.dwtag  DW_TAG_loop_range
	.dwattr DW$37, DW_AT_low_pc(DW$L$_VfdDataLoad$2$B)
	.dwattr DW$37, DW_AT_high_pc(DW$L$_VfdDataLoad$2$E)
DW$38	.dwtag  DW_TAG_loop_range
	.dwattr DW$38, DW_AT_low_pc(DW$L$_VfdDataLoad$11$B)
	.dwattr DW$38, DW_AT_high_pc(DW$L$_VfdDataLoad$11$E)

DW$39	.dwtag  DW_TAG_loop
	.dwattr DW$39, DW_AT_name("H:\Tracer_Mouse\Mouse\SPIDER_MINE\main\VFD.asm:L5:2:1675863922")
...
DW$40	.dwtag  DW_TAG_loop_range
	.dwattr DW$40, DW_AT_low_pc(DW$L$_VfdDataLoad$3$B)
	.dwattr DW$40, DW_AT_high_pc(DW$L$_VfdDataLoad$3$E)
DW$41	.dwtag  DW_TAG_loop_range
	.dwattr DW$41, DW_AT_low_pc(DW$L$_VfdDataLoad$5$B)
	.dwattr DW$41, DW_AT_high_pc(DW$L$_VfdDataLoad$5$E)
DW$42	.dwtag  DW_TAG_loop_range
	.dwattr DW$42, DW_AT_low_pc(DW$L$_VfdDataLoad$10$B)
	.dwattr DW$42, DW_AT_high_pc(DW$L$_VfdDataLoad$10$E)

DW$43	.dwtag  DW_TAG_loop
	.dwattr DW$43, DW_AT_name("H:\Tracer_Mouse\Mouse\SPIDER_MINE\main\VFD.asm:L6:3:1675863922")
...
DW$44	.dwtag  DW_TAG_loop_range
	.dwattr DW$44, DW_AT_low_pc(DW$L$_VfdDataLoad$4$B)
	.dwattr DW$44, DW_AT_high_pc(DW$L$_VfdDataLoad$4$E)
	.dwendtag DW$43


DW$45	.dwtag  DW_TAG_loop
	.dwattr DW$45, DW_AT_name("H:\Tracer_Mouse\Mouse\SPIDER_MINE\main\VFD.asm:L7:3:1675863922")
...
DW$46	.dwtag  DW_TAG_loop_range
	.dwattr DW$46, DW_AT_low_pc(DW$L$_VfdDataLoad$6$B)
	.dwattr DW$46, DW_AT_high_pc(DW$L$_VfdDataLoad$6$E)
DW$47	.dwtag  DW_TAG_loop_range
	.dwattr DW$47, DW_AT_low_pc(DW$L$_VfdDataLoad$7$B)
	.dwattr DW$47, DW_AT_high_pc(DW$L$_VfdDataLoad$7$E)
DW$48	.dwtag  DW_TAG_loop_range
	.dwattr DW$48, DW_AT_low_pc(DW$L$_VfdDataLoad$8$B)
	.dwattr DW$48, DW_AT_high_pc(DW$L$_VfdDataLoad$8$E)
DW$49	.dwtag  DW_TAG_loop_range
	.dwattr DW$49, DW_AT_low_pc(DW$L$_VfdDataLoad$9$B)
	.dwattr DW$49, DW_AT_high_pc(DW$L$_VfdDataLoad$9$E)
	.dwendtag DW$45
	...
	.dwattr DW$21, DW_AT_end_file("VFD.c")
	.dwattr DW$21, DW_AT_end_line(0xf9)
...
DW$50	.dwtag  DW_TAG_subprogram, DW_AT_name("VFDPrintf"), DW_AT_symbol_name("_VFDPrintf")
	.dwattr DW$50, DW_AT_low_pc(_VFDPrintf)
	.dwattr DW$50, DW_AT_high_pc(0x00)
	.dwattr DW$50, DW_AT_begin_file("VFD.c")
	.dwattr DW$50, DW_AT_begin_line(0xfb)
	.dwattr DW$50, DW_AT_begin_column(0x06)
	.dwpsn	"VFD.c",252,1

	.dwfde DW$CIE
DW$51	.dwtag  DW_TAG_variable, DW_AT_name("Buff"), DW_AT_symbol_name("_Buff$1$0")
	.dwattr DW$51, DW_AT_type(*DW$T$61)
	.dwattr DW$51, DW_AT_location[DW_OP_addr _Buff$1$0]
...
DW$52	.dwtag  DW_TAG_formal_parameter, DW_AT_name("Form"), DW_AT_symbol_name("_Form")
	.dwattr DW$52, DW_AT_type(*DW$T$31)
...
DW$54	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	...
	.dwcfa	0xc0, 11
        LRETR
        ; return occurs
	.dwattr DW$50, DW_AT_end_file("VFD.c")
	.dwattr DW$50, DW_AT_end_line(0x103)
...
DW$56	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$31)
	.dwendtag DW$T$32
...
DW$59	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$31)
DW$60	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$39)
...
DW$T$49	.dwtag  DW_TAG_const_type
	.dwattr DW$T$49, DW_AT_type(*DW$62)
...
DW$T$57	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$57, DW_AT_type(*DW$63)
...
DW$64	.dwtag  DW_TAG_subrange_type
	.dwattr DW$64, DW_AT_upper_bound(0x7f)
DW$65	.dwtag  DW_TAG_subrange_type
	.dwattr DW$65, DW_AT_upper_bound(0x04)
	.dwendtag DW$T$60
...
DW$66	.dwtag  DW_TAG_subrange_type
	.dwattr DW$66, DW_AT_upper_bound(0x13)
	.dwendtag DW$T$61
...
DW$T$53	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$53, DW_AT_type(*DW$67)
DW$68	.dwtag  DW_TAG_far_type
	.dwattr DW$68, DW_AT_type(*DW$T$23)
DW$T$55	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$55, DW_AT_type(*DW$68)
...
DW$78	.dwtag  DW_TAG_far_type
	.dwattr DW$78, DW_AT_type(*DW$T$30)
DW$T$38	.dwtag  DW_TAG_const_type
	.dwattr DW$T$38, DW_AT_type(*DW$78)
