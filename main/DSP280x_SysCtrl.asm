...
;	..\Compiler\bin\opt2000.exe C:\Users\JS\AppData\Local\Temp\TI48010 C:\Users\JS\AppData\Local\Temp\TI4804 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\JS\AppData\Local\Temp\TI4802 --template_info_file C:\Users\JS\AppData\Local\Temp\TI4806 --object_file DSP280x_SysCtrl.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_ServiceDog
...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("H:\Tracer_Mouse\Mouse\SPIDER_MINE\main\DSP280x_SysCtrl.asm:L3:1:1675693980")
...
;*** 272	-----------------------    *(&SysCtrlRegs+13L) |= 0x10u;
;*** 273	-----------------------    *(&SysCtrlRegs+13L) |= 0x20u;
;*** 274	-----------------------    *(&SysCtrlRegs+12L) |= 4u;
;*** 276	-----------------------    asm(" EDIS");
;*** 276	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
...
DW$12	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
 ...
 EALLOW
	...
	.dwpsn	"DSP280x_SysCtrl.c",272,2
        OR        @_SysCtrlRegs+13,#0x0010 ; |272| 
	.dwpsn	"DSP280x_SysCtrl.c",273,2
        OR        @_SysCtrlRegs+13,#0x0020 ; |273| 
	.dwpsn	"DSP280x_SysCtrl.c",274,2
        OR        @_SysCtrlRegs+12,#0x0004 ; |274| 
	.dwpsn	"DSP280x_SysCtrl.c",276,5
 EDIS
	.dwpsn	"DSP280x_SysCtrl.c",277,1
        SPM       #0
        LRETR
        ; return occurs
	.dwattr DW$11, DW_AT_end_file("DSP280x_SysCtrl.c")
	.dwattr DW$11, DW_AT_end_line(0x115)
