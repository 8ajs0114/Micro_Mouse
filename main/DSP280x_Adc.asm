...
;* Date/Time created: Mon Feb 06 23:32:58 2023                 *
;***************************************************************
...
;	..\Compiler\bin\opt2000.exe C:\Users\JS\AppData\Local\Temp\TI55610 C:\Users\JS\AppData\Local\Temp\TI5564 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\JS\AppData\Local\Temp\TI5562 --template_info_file C:\Users\JS\AppData\Local\Temp\TI5566 --object_file DSP280x_Adc.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_InitAdc
...
;*** 71	-----------------------    *((volatile struct _ADCCHSELSEQ1_BITS *)C$1+3L) &= 0xfff0u;
;*** 81	-----------------------    AdcRegs.ADCTRL3.all = 228u;
;*** 83	-----------------------    DSP28x_usDelay(139998uL);
;*** 83	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$6	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
 ...
 EDIS
	...
	.dwpsn	"DSP280x_Adc.c",71,2
        AND       *+XAR4[3],#0xfff0     ; |71| 
	.dwpsn	"DSP280x_Adc.c",81,2
        MOV       @_AdcRegs+24,#228     ; |81| 
	.dwpsn	"DSP280x_Adc.c",83,5
        MOV       AL,#8926
        SPM       #0
        MOV       AH,#2
        LCR       #_DSP28x_usDelay      ; |83| 
        ; call occurs [#_DSP28x_usDelay] ; |83| 
	.dwpsn	"DSP280x_Adc.c",86,1
        LRETR
        ; return occurs
	.dwattr DW$5, DW_AT_end_file("DSP280x_Adc.c")
	.dwattr DW$5, DW_AT_end_line(0x56)
