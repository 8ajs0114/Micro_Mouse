...
;* Date/Time created: Wed Feb 08 23:54:29 2023                 *
;***************************************************************
...
_InitGpio:
;*** 27	-----------------------    asm(" EALLOW");
;*** 66	-----------------------    GpioCtrlRegs.GPAMUX1.all = 1114112uL;
...
;*** 193	-----------------------    return;
	...
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
	.dwpsn	"DSP280x_Gpio.c",27,5
 EALLOW
	.dwpsn	"DSP280x_Gpio.c",66,3
        MOVL      XAR4,#1114112         ; |66| 
        MOVW      DP,#_GpioCtrlRegs+6
        MOVL      @_GpioCtrlRegs+6,XAR4 ; |66| 
	.dwpsn	"DSP280x_Gpio.c",106,3
        MOV       PH,#1290
        MOV       PL,#1301
        MOVL      @_GpioCtrlRegs+8,P    ; |106| 
	.dwpsn	"DSP280x_Gpio.c",117,3
        MOVB      ACC,#0
        MOVL      @_GpioCtrlRegs+22,ACC ; |117| 
	.dwpsn	"DSP280x_Gpio.c",160,3
        MOV       PH,#11469
        MOV       PL,#16383
        MOVL      @_GpioCtrlRegs+10,P   ; |160| 
	.dwpsn	"DSP280x_Gpio.c",169,3
        MOVB      ACC,#7
        MOVL      @_GpioCtrlRegs+26,ACC ; |169| 
	.dwpsn	"DSP280x_Gpio.c",184,3
        MOV       PH,#52431
        MOV       PL,#65535
        MOVL      @_GpioCtrlRegs+12,P   ; |184| 
	.dwpsn	"DSP280x_Gpio.c",185,3
        MOV       PH,#65535
        MOVL      @_GpioCtrlRegs+28,P   ; |185| 
	.dwpsn	"DSP280x_Gpio.c",187,3
        MOVB      ACC,#0
        MOVL      @_GpioCtrlRegs+2,ACC  ; |187| 
	.dwpsn	"DSP280x_Gpio.c",188,3
        MOVL      @_GpioCtrlRegs+4,ACC  ; |188| 
	.dwpsn	"DSP280x_Gpio.c",189,3
        MOVL      @_GpioCtrlRegs+18,ACC ; |189| 
	.dwpsn	"DSP280x_Gpio.c",193,2
 EDIS
	.dwpsn	"DSP280x_Gpio.c",194,1
        SPM       #0
        LRETR
        ; return occurs
	.dwattr DW$2, DW_AT_end_file("DSP280x_Gpio.c")
	.dwattr DW$2, DW_AT_end_line(0xc2)
